...
\begin{document}
\title{Suggestions for Transparent and Reproducible Social Science Research}
...
This article is intended to be a source mainly for empirical social
...
The article is laid out as follows: in section~\ref{ethical-research} we first discuss the motivation for this document: the
